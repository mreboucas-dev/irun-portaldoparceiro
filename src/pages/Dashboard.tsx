  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visão geral do impacto iRun</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard className="animate-fade-in-up stagger-4">
          <h3 className="text-lg font-semibold mb-4 text-foreground">Resgates por Categoria</h3>
        ...
        <GlassCard className="animate-fade-in-up stagger-5">
          <h3 className="text-lg font-semibold mb-4 text-foreground">Engajamento Semanal</h3>
          <ChartContainer config={lineChartConfig} className="h-[300px]">
            <LineChart data={engajamentoSemanal}>
              ...
              <YAxis stroke="hsl(var(--muted-foreground))" fontSize={12} />
              <ChartTooltip content={<ChartTooltipContent />} />
              <Line type="monotone" dataKey="ativos" stroke="var(--color-ativos)" strokeWidth={2} dot={{ r: 4 }} />
              <Line type="monotone" dataKey="resgates" stroke="var(--color-resgates)" strokeWidth={2} dot={{ r: 4 }} />
            </LineChart>
          </ChartContainer>
        </GlassCard>
      </div>
